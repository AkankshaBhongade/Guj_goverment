...
//	private Long bank_id;
	...
	public BankBranchEntity(Long bank_branch_id, MsBankEntity bank_id, String branch_name, String bank_name_guj,
			...
			LocalDateTime updated_date, Long updated_by_post, Short active_status, Long district_id, Long taluka_id,
			String ifsc_code, String micr_code, String branch_addr, String branch_email, String branch_phone,
			Long is_merged_branch, Long is_enabled_branch) {
		super();
...
//
//	public MsBankEntity getBank_id() {
//		return bank_id;
//	}
//


	public void setBank_id(MsBankEntity bank_id) {
		this.bank_id = bank_id;
	}
