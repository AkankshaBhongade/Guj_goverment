...
public class MsgConstant {
	...
	/** The Constant DOI_MSG_CREATE. */
	public static final String DOI_MSG_CREATE = MessageUtil.getMsg("DOI.CREATE");

	/** The Constant DOI_MAX_INWARD_NO. */
	public static final String DOI_MSG_FETCH_MAX_INWARD_OUTWARD_NO = MessageUtil
			.getMsg("DOI.FETCH.MAX.INWARD.OUTWARD.NO");

	/** The Constant DOI_MSG_FETCH_BANKBRANCHES. */
	public static final String DOI_MSG_FETCH_BANK_BRANCHES = MessageUtil.getMsg("DOI.FETCH.BANK.BRANCHES");

	/** The Constant DOI_LISTING_FILTER. */
	public static final String DOI_LISTING_FILTER = MessageUtil.getMsg("DOI.LISTING.FILTER");

	/** The Constant DOI_MSG_FETCH. */
	public static final String DOI_MSG_FETCH = MessageUtil.getMsg("DOI.FETCH");

	/** The Constant DOI_MSG_UPDATE. */
	public static final String DOI_MSG_UPDATE = MessageUtil.getMsg("DOI.UPDATE");

	/** The Constant DOI_MSG_DELETE. */
	public static final String DOI_MSG_DELETE = MessageUtil.getMsg("DOI.DELETE");
	...
	/**
	 * The Constant
	 * ERROR_TPP_MONTHLY_ENTERED_AMOUNT_MUST_BE_LESSTHAN_OR_EQUALS_TO_ARREAR_AMOUNT.
	 */
	...
	// public static final String VALIDATIONS_DONE =
	// MessageUtil.getMsg("VALIDATIONS.DONE");
