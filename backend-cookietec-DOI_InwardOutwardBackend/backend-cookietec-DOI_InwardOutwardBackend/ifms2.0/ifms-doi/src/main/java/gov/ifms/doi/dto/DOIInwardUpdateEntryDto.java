...
public class DOIInwardUpdateEntryDto implements Serializable {
	...
	public DOIInwardUpdateEntryDto() {
		super();
	}

	public DOIInwardUpdateEntryDto(String inward_id, String inward_no, LocalDate inward_dt, String letter_type,
