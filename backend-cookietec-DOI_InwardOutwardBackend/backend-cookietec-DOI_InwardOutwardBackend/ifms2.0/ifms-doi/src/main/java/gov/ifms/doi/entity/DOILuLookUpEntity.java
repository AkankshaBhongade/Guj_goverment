 ...
 */
@Entity
@Table(name = "LU_LOOKUP", schema = Constant.DOI_MASTER_SCHEMA)
public class DOILuLookUpEntity extends BaseEntity implements Serializable {
	...
	@OneToMany(mappedBy = "parentLookupId")
	private Set<DOILuLookUpInfoEntity> lu_lookup_info = new HashSet<>();
	...
	public Set<DOILuLookUpInfoEntity> getLu_lookup_info() {
		return lu_lookup_info;
	}
