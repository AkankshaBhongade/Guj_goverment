...
import com.AccountAdminMdule.util.MessageUtil;
...
public class MsgConstant {
	...
	public static String DOI_AC_ADMIN_MSG_FETCH = MessageUtil.getMsg("AC_ADMIN.FETCH.LIST");

	public static String DOI_AC_MSG_CREATE = MessageUtil.getMsg("AC_ADMIN.CREATE.LIST");

	public static String DOI_AC_MSG_DELETE = MessageUtil.getMsg("AC_ADMIN.DELETE.LIST");

	public static String DOI_AC_MSG_UPDATE = MessageUtil.getMsg("AC_ADMIN.UPDATE.LIST");

	public static String BTR_LISTING_FILTER = MessageUtil.getMsg("AC_ADMIN.BTRFILTER.LIST");

	public static String CHALLAN_LISTING_FILTER = MessageUtil.getMsg("AC_ADMIN.CHALLANFILTER.LIST");

	public static String CB_RECEIPT_LISTING_FILTER  = MessageUtil.getMsg("AC_ADMIN.CBRECEIPTFILTER.LIST");


	public static String CB_PAYMENT_LISTING_FILTER = MessageUtil.getMsg("AC_ADMIN.CBPAYMENTFILTER.LIST");
